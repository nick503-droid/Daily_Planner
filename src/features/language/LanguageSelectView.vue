...
<template>
  <div class="w-full max-w-md mx-auto h-screen flex flex-col items-center justify-center gap-8 p-6 bg-white dark:bg-[#1a1a2e] text-center">
    ...
    <div class="w-full space-y-3">
      <button
        @click="choose('es')"
        class="w-full p-4 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white rounded-2xl font-bold transition-all"
      >
        Español
      </button>
      <button
    ...
    <p class="text-xs text-slate-400">
      Puedes cambiarlo luego en Configuración · You can change this later in Settings
    </p>
  </div>
</template>
